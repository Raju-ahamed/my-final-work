...
// Run once on page load
    ...
    // Animation on scroll
    function animateOnScroll() {
        const elements = document.querySelectorAll('.about-content, .about-text, .service-card,.service-card2');
        ...
        const elements2 = document.querySelectorAll('.member-card, .contact-content');
        ...
        elements2.forEach(element2 => {
            ...
            if (elementPosition < screenPosition) {
                element2.classList.add('animate', 'show2');
            }
        });
    }
    
    // Set initial state for animated elements
    document.querySelectorAll('.about-content,.about-text, .service-card,.service-card2').forEach(element => {
        element.classList.add('animate');
        
    });
    document.querySelectorAll('.member-card, .contact-content').forEach(element => {
        element.classList.add('animate');
